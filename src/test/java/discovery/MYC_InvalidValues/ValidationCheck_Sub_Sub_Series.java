...
public class ValidationCheck_Sub_Sub_Series extends Wrapper_methods{
	...
	public void validationcheck() throws IOException, InterruptedException{
		...
		Thread.sleep(3000);
		Runtime.getRuntime().exec("./AUTOIT/Sub_Sub_Series.exe");
		Thread.sleep(3000);
		...
		Assert.assertTrue(Actual_Error.contains("Expected a valid level hierarchy, can't have sub-sub-series directly under the series"));
