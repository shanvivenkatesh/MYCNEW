...
public class ValidationCheck_FondsWithNoLegalStatus extends Wrapper_methods{
	...
	public void validationcheck() throws IOException, InterruptedException{
		...
		Thread.sleep(3000);
		Runtime.getRuntime().exec("./AUTOIT/FondsWithNoLegalStatus.exe");
		Thread.sleep(3000);
		...
		Assert.assertTrue(Actual_Error.contains("Error Legal status required at 'fonds' level"));
		quitBrowser();
