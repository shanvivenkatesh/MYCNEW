...
public class ValidationCheck_FondsWithNoStartAndEndDate extends Wrapper_methods{
	...
	public void validationcheck() throws IOException, InterruptedException{
		...
		Thread.sleep(3000);
		Runtime.getRuntime().exec("./AUTOIT/FondsWithNoStartAndEndDate.exe");
		Thread.sleep(3000);
		...
		Assert.assertTrue(Actual_Error.contains("Start date should be in the form of yyyymmdd or yyyy"));
